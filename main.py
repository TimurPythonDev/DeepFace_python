import cv2 # rasimlar ustida generatsiya olib boradi
import numpy as np # matimatik amallar uchun kerak
import mediapipe as mp # rasidagi harakatlarni aniqlash uchun
import sys # environmentslar bilan ishlash uchun


# kamera oynasi uchun o'lcham
width = 640
height = 480

# kamerani yoqadi va yoqilgan kameradan videoni saqlab oladi
cap = cv2.VideoCapture(0)
result1=cv2.VideoWriter('deepfaceVideo.avi', cv2.VideoWriter_fourcc(*'MJPG'), 25, (640,480))
cap.set(3, width)
cap.set(4, height)
...
#  yuzni o'lchamlarini olish uchun functions
